...
class MainTabBarController: UITabBarController{
    ...
    func setUpViewControllers(){
        self.viewControllers = [setUpTabBarItens(rootViewController: FavoritesController(collectionViewLayout: UICollectionViewFlowLayout()), title: "Favorites", image: #imageLiteral(resourceName: "favorites")), setUpTabBarItens(rootViewController: SearchViewController() , title: "Search", image: #imageLiteral(resourceName: "search")), setUpTabBarItens(rootViewController: DownloadsViewController() , title: "Downloads", image:#imageLiteral(resourceName: "downloads"))]
    }
